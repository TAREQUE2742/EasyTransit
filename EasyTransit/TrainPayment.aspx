<%@ Page Title="Train Payment" Language="C#" MasterPageFile="~/RUser.Master" AutoEventWireup="true" CodeBehind="TrainPayment.aspx.cs" Inherits="EasyTransit.TrainPayment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <table class="auto-style1">
                ...
                &nbsp;
                <tr>
                    <td class="auto-style15"><strong>Train Company Name :</strong></td>
                ...
                &nbsp;
                <tr>
                    <td class="auto-style13"><strong>Train ID :</strong></td>
                ...
                &nbsp;
                <tr>
                    <td class="auto-style7"><strong>Origin Station :</strong></td>
                    <td class="auto-style8">
                        <asp:Label ID="lbloriginstation" Font-Bold="true" ForeColor="green" runat="server" ></asp:Label>
                    </td>
                </tr>
                &nbsp;
                <tr>
                    <td class="auto-style5"><strong>Destination Station:</strong></td>
                    <td class="auto-style6">
                        <asp:Label ID="lbldestinationstation" Font-Bold="true" ForeColor="green" runat="server" ></asp:Label>
                    </td>
                </tr>
                &nbsp;
                <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style22">
                        <asp:Label ID="lblTrainfare" runat="server" CssClass="form-control" Height="28px" Width="100%"></asp:Label>
                    </td>
                </tr>
                &nbsp;
                <tr>
